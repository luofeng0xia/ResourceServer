...
import com.example.weixi.resourceserver.Servlet.FeedbackServlet;
...
import com.example.weixi.resourceserver.Servlet.UploadTikuServlet;
...
public class ServlertConfig {
	public static void config(ServletContextHandler handler) {
		...
		handler.addServlet(new ServletHolder(new FeedbackServlet()), "/feedback");
	}
}
